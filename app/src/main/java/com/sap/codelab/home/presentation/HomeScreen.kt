...
import com.sap.codelab.home.presentation.components.MemoItem
            ...
            TopAppBar(
                ...
                actions = {
                    TextButton(onClick = {
                        ...
                        Text(
                            if (showAll) stringResource(R.string.action_show_all) else stringResource(
                                R.string.action_show_open
                            )
                        )
                    }
                }
